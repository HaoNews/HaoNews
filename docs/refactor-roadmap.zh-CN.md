...
这份文档把前面的设计文档收敛成主线改造路线图，并标记当前已经完成到哪里。
...
改造被拆成 6 个阶段。当前主线已经完成了大部分基础工作，并进入持续收尾与收紧阶段。
...
这份路线图现在已经不只是“准备怎么做”，而是：

- 主线边界已经建立
- 默认 news 参考应用已经拆成 4 个功能插件 + 1 个默认 theme
- 第三方 app/plugin/theme 的创建、检查、安装、链接、启动链路已经可用
- 当前重点转为共享层收紧、文档对齐和开发者体验打磨
