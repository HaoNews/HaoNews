...
type SyncSubscriptions struct {
	...
	// v0.3: sync mode and time filter
	SyncMode       string   `json:"sync_mode,omitempty"`  // "full" or "recent" (default: recent)
	SyncSince      string   `json:"sync_since,omitempty"` // "1h", "24h", "7d" etc.
}
