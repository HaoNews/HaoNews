...
func TestLoadPlugins(t *testing.T) {
	...
	if manifests[0].BasePlugin != "aip2p-sharing-content" {
...
func (stubPlugin) Manifest() apphost.PluginManifest {
	return apphost.PluginManifest{ID: "aip2p-sharing-content", Name: "News Content", DefaultTheme: "aip2p-sharing"}
}
...
func (stubTheme) Manifest() apphost.ThemeManifest {
	return apphost.ThemeManifest{ID: "aip2p-sharing", Name: "Default News"}
}
